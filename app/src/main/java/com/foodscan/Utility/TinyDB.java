...
public class TinyDB {
     ...
     * @param value returned if key was not found
    ...
    public String getStringDef(String key, String defVal) {
     ...
     *
     * @param key     SharedPreferences key
     * @param boolean value returned if key was not found
...
//    public void saveCartSelfie(String key, ArrayList<DTOSelfie> arrayList) {
//        //preferences.edit();
//        Gson gson = new Gson();
...
//    }
//
//    public ArrayList<DTOSelfie> getCartSelfie(String key){
//        Gson gson = new Gson();
//        String json = preferences.getString(key, "");
//        Type type = new TypeToken<ArrayList<DTOSelfie>>() {}.getType();
//        ArrayList<DTOSelfie> arrayList = gson.fromJson(json, type);
//
//        return arrayList;
//
//    }
